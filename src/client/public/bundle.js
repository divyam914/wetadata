...
var _navbarItem = __webpack_require__(30);
...
var NavBar = function (_React$Component) {
  ...
  _createClass(NavBar, [{
    ...
    value: function generateItem(item) {
      return _react2.default.createElement(_navbarItem2.default, { text: item.text, url: item.url, submenu: item.submenu });
    }
  }, {
    key: 'render',
...
var _navbarData = __webpack_require__(32);

var _navbarData2 = _interopRequireDefault(_navbarData);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_navbar2.default, { items: _navbarData2.default })
      );
    }
  }]);
...
var _navbarLink = __webpack_require__(31);
...
var NavBarItem = function (_React$Component) {
  ...
  _createClass(NavBarItem, [{
    ...
    value: function generateLink() {
      ...
      return _react2.default.createElement(_navbarLink2.default, { url: this.props.url, text: this.props.text });
    }
  }, {
    key: 'generateSubmenu',
    value: function generateSubmenu() {
      //We generate a simple Navbar (the parent).
      //Spoilers: it takes items as its argument.
      return _react2.default.createElement(_navbar2.default, { items: this.props.submenu });
    }
  }, {
    key: 'generateContent',
...
var NavBarLink = function (_React$Component) {
